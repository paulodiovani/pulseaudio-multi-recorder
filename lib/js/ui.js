...
(function() {
  ...
  Ui = (function() {
    ...
    Ui.prototype.actions_menu = function() {
      ...
      this.menu.on('select', this.on_action_selected.bind(this));
      this.menu.focus();
      screen.render();
      return this;
    };
    ...
    Ui.prototype.on_action_selected = function(item, index) {
      switch (index) {
        case 0:
          return command.list_sinks(this.action_list.bind(this));
        case 2:
          return command.list_sources(this.action_list.bind(this));
        case 5:
          return process.exit(0);
      }
    };
    ...
    Ui.prototype.action_list = function(err, data) {
      var content, listbox, okbutton, on_onbutton_press;
      if (err) {
      ...
      on_onbutton_press = function() {
        listbox.detach();
        this.menu.focus();
        return screen.render();
      };
      okbutton.on('press', on_onbutton_press.bind(this));
      okbutton.focus();
      return screen.render();
    };
